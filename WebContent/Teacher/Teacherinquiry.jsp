...
<body>
	<form action="TeacherinquiryPro.to" method="post" name="frm" id="frm">
		<table border="1" width="60%" heigth="30%">
			...
			<tr>
				...
				<td>
					<input type="text" class="form-control" style="width:500px;display:inline" name="TeacherTitle" id="TeacherTitle" placeholder="제목을 입력해 주세요">
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<textarea rows="20" cols="65" name="Teachercontent" id="Teachercontent"></textarea>
				</td>
			</tr>
